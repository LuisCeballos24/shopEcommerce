...
export function CartItem({ item }) {
    ...
    if (!item) return <div>Item no disponible</div>;
    ...
    return (
        <div className='py-4 px-2 sm:px-4 border-b'>
            <div className='flex justify-between'>
                ...
                <button className='h-fit pt-2 cursor-pointer' onClick={() => removeProduct(item.producto_id)}>
            ...
            <div className='flex justify-between items-center relative mt-4 sm:mt-2 sm:justify-end'>
                ...
                <div className='relative right-0 bottom-0 sm:right-[140px] sm:absolute'>
                    <button
                        ...
                        onClick={() => decrementProduct(item.producto_id)}
                    >
                    ...
                    <button
                        ...
                        onClick={() => incrementProduct(item.producto_id)}
                    >
